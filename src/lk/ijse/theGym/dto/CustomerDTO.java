...
public class CustomerDTO {
    ...
    public CustomerDTO(String customer_id, String fist_name, String last_name, String address_street, String address_city, String address_lene, String e_mail, String birthday, String nic, String contact_number, String gender, String package_id, String package_activate_date, String date) {
    ...
    public CustomerDTO toDTO(Customer customer) {
        ...
        this.fist_name = customer.getFist_name();
        this.last_name = customer.getLast_name();
        this.address_street = customer.getAddress_street();
        this.address_city = customer.getAddress_city();
        this.address_lene = customer.getAddress_lene();
        this.e_mail = customer.getE_mail();
        this.birthday = customer.getBirthday();
        this.nic = customer.getNic();
        this.contact_number = customer.getContact_number();
        this.gender = customer.getGender();
        this.package_id = customer.getPackage_id();
        this.package_activate_date = customer.getPackage_activate_date();
