...
public class CoachController {
   ...
   /* public static ResultSet getLastaId() throws SQLException, ClassNotFoundException {
    ...
    /*public static boolean addCoach(CoachDTO coach) throws SQLException, ClassNotFoundException {
  ...
  /*  public static boolean removeCustomer(String text) throws SQLException, ClassNotFoundException {
   ...
   /* public static boolean updateCustomer(CustomerDTO customer) throws SQLException, ClassNotFoundException {
    ...
    /*public static boolean updateCoach(CoachDTO coach) throws SQLException, ClassNotFoundException {
  ...
  /*  public static String getCoachCunt() throws SQLException, ClassNotFoundException {
