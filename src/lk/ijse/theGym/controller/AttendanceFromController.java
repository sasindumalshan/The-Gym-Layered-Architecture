    ...
    public void idOnkeyTyped(KeyEvent keyEvent) {
        try {
            ...
            if (searchDuplicateId()) {
                ...
                boolean eNot = false;
                boolean mNot = false;
//                CustomerController.idExists(txtId.getText())
                if (customerBO.getCustomer(txtId.getText())!=null) {
                    boolean added = CustomerAttendanceController.setAttendance(new CustomerAttendanceDTO(DateTimeUtil.dateNow(), DateTimeUtil.timeNow(), txtId.getText()));
                    if (added){
...
//                CoachController.idExists(txtId.getText())
                if (coachBO.get(txtId.getText())!=null) {
                    boolean added = CoachAttendanceController.setAttendance(new CoachAttendanceDTO(DateTimeUtil.dateNow(), DateTimeUtil.timeNow(), txtId.getText()));
                    if (added){
                        Notification.notification("Mark Attendance","successful Mark on today  Attendance ");
                    }
                    txtId.setText("");
