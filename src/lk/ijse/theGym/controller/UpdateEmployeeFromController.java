...
public class UpdateEmployeeFromController implements Initializable {
    ...
    public void updateOnAction(ActionEvent actionEvent) {
        if (txtFName.getText().equals("") |
            ...
            try {
                /*boolean isUpdate=EmployeeController.Update(new EmployeeDTO(
                        "",
                        txtFName.getText(),
                        txtLName.getText(),
                        txtUserName.getText(),
...
//            ResultSet set = EmployeeController.getAllData();
            ...
            txtUserName.setText(employeeDTO.getUsr_name());
            txtPassword.setText(employeeDTO.getPassword());
            combRole.setValue(employeeDTO.getRoll());
            ...
            DpBirthday.setId(employeeDTO.getBirthday());
