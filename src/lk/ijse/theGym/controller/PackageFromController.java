    ...
    private void setPackData() {
        ...
        try {
            ...
            while (set.next()) {
                ...
                String packageUsageCount = customerBO.getPackageUsageCount(set.getString(4));
                if (packageUsageCount!=null) {
                    navigation(set.getString(4), set.getString(2), set.getString(3), set.getString(1),packageUsageCount);
